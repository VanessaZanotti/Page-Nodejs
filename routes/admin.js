...
router.post('/categorias/nova', eAdmin, (req, res) => {
  validaErrosCategoria(req.body.nome, req.body.slug);
...
function validaErrosCategoria(nome, slug) {
  erros = [];
...
router.get('/usuarios/:id', eAdmin, (req, res) => {
  ...
  /* Usuario.findOne({ _id: req.params.id })
    ...
    .catch((error) => {
      req.flash('error_msg', 'Houve um erro ao exibir o usuário.');
